...
constlen=7; %7 is the contrain length of the convolutional code
codegen = [171 133];    % Polynomial of the input/output relation on OCT
trellis = poly2trellis(constlen, codegen); %used for convolutionally encode/decode
